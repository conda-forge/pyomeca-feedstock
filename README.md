About pyomeca-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyomeca-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6828&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyomeca-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyomeca` can be installed with `conda`:
...
```
mamba install pyomeca
```

It is possible to list all of the versions of `pyomeca` available on your platform with `conda`:
...
```
mamba search pyomeca --channel conda-forge
```
...
mamba repoquery search pyomeca --channel conda-forge

# List packages depending on `pyomeca`:
mamba repoquery whoneeds pyomeca --channel conda-forge

# List dependencies of `pyomeca`:
mamba repoquery depends pyomeca --channel conda-forge
```
